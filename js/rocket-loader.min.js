!function() {
    ...
    function t() {
        for (var t, e = [], n = 0; n < arguments.length; n++)
            e[n] = arguments[n];
        (t = console.warn || console.log).call.apply(t, [console, "[ROCKET LOADER] "].concat(e))
    }
    function e(t, e) {
        var n = e.parentNode;
        n && p(t, n, e)
    ...
    function i(t, e) {
        ...
        return !(n && !v[n.trim()]) && (!y || !t.hasAttribute("nomodule")) && !(!y && "module" === n)
    }
    function o(t) {
        return i(t, "")
    }
    ...
    function c(t, e) {
        t.onload = a(t.onload, e),
        t.onerror = a(t.onerror, e)
    }
    function s(t) {
    ...
    function p(t, e, n) {
        Array.prototype.slice.call(t).forEach(n ? function(t) {
    ...
    var f, d, h = "http://www.w3.org/2000/svg", v = {
        ...
        "text/x-javascript": !0,
        module: !0
    }, y = void 0 !== document.createElement("script").noModule, m = ((f = window).__rocketLoaderEventCtor || Object.defineProperty(f, "__rocketLoaderEventCtor", {
        value: Event
    }),
    f.__rocketLoaderEventCtor), b = document.write, g = document.writeln, S = Object.setPrototypeOf || ({
        __proto__: []
    ...
    , x = function() {
        ...
        return n.prototype.enable = function(t) {
            var e = this;
        ...
        n.prototype.flushWrittenContentAndDisable = function() {
            document.write = b,
            document.writeln = g,
            this.buffer.length && (document.contains(this.insertionPointMarker) ? this.insertionPointMarker.parentNode === document.head ? this.insertContentInHead() : this.insertContentInBody() : t("Insertion point marker for document.write was detached from document:", "Markup will not be inserted"))
        }
        ,
        n.prototype.insertContentInHead = function() {
            ...
            if (this.scriptStack.harvestScriptsAfterDocWrite(r),
            e(r.head.childNodes, this.insertionPointMarker),
            r.body.childNodes.length) {
                for (var i, o, a = Array.prototype.slice.call(r.body.childNodes), c = this.insertionPointMarker.nextSibling; c; )
                    a.push(c),
                    c = c.nextSibling;
        ...
        n.prototype.write = function(t, e) {
            var n, i = document.currentScript;
            i && r(i) && i.hasAttribute("async") ? (n = e ? g : b).call.apply(n, [document].concat(t)) : this.buffer += t.map(String).join(e ? "\n" : "")
        }
        ,
        n
    }(), A = function() {
        ...
        t.prototype.patchEventTargetMethods = function(t) {
            ...
            t.addEventListener = function(t, r) {
                for (var i = [], o = 2; o < arguments.length; o++)
                    i[o - 2] = arguments[o];
                var a, c = (a = this,
                a instanceof Window ? ["load"] : a instanceof Document ? ["DOMContentLoaded", "readystatechange"] : []), s = r && r.__rocketLoaderProxiedHandler;
                if (!s) {
                    var u = function t(e) {
                    ...
                    "function" == typeof u ? Object.defineProperty(r, "__rocketLoaderProxiedHandler", {
                        value: s = function(n) {
        ...
        t.prototype.proxyInlineHandler = function(t, e) {
            try {
                ...
                return void console.warn("encountered an error when accessing " + e + " handler:", i.message)
            }
        }
        ,
        t
    }(), $ = ((d = window).__rocketLoaderLoadProgressSimulator || Object.defineProperty(d, "__rocketLoaderLoadProgressSimulator", {
        value: new A
    }),
    d.__rocketLoaderLoadProgressSimulator), w = function() {
        function e(t, e) {
            this.scriptStack = t,
            this.settings = e,
            this.preloadHints = []
        }
        return e.prototype.insertPreloadHints = function() {
            var t = this;
            this.scriptStack.forEach(function(e) {
                if (i(e, t.settings.nonce)) {
                    var n = r(e)
                      , o = /chrome/i.test(navigator.userAgent) && /google/i.test(navigator.vendor) && e.hasAttribute("integrity");
                    if (n && !o) {
        ...
        e.prototype.run = function() {
            for (var t = this, e = this; this.scriptStack.hasItems; ) {
                var n = function() {
                    ...
                    return i ? r.external && r.executable && !r.async ? (c(i, function() {
        ...
        e.prototype.activateScript = function(e) {
            ...
            if (!document.contains(i))
                return t("Placeholder for script \n" + r.outerHTML + "\n was detached from document.", "Script will not be executed."),
                null;
            var u = this.settings.blocking && o && !a ? function t(e) {
            ...
            return u ? (c.insertBefore(u, i),
            u) : (t("Failed to create activatable copy of script \n" + r.outerHTML + "\n", "Script will not be executed."),
            null)
        }
        ,
        e
    ...
    !function() {
        ...
        if (e) {
            var r, i, o, a, c, s, u, p, l, f, d = function t(e) {
            ...
            Array.prototype.forEach.call(document.querySelectorAll("[" + i + "]"), function(t) {
                t.removeAttribute(i),
                Array.prototype.forEach.call(t.attributes, function(e) {
                    /^on/.test(e.name) && "function" != typeof t[e.name] && t.setAttribute(e.name, e.value.substring(r.handlerPrefixLength))
                })
            }),
            $.updateInlineHandlers(),
            d.bailout ? (o = d.nonce,
            ...
            "undefined" != typeof Promise && (s.__cfQR = {
            ...
            (f = new w(p,{
                ...
                callback: function() {
                    ...
                    new w(e,{
                        ...
                        blocking: !1,
                        callback: function() {
                            $.simulateStateAfterDeferScriptsActivation(),
                            I && I()
                        }
                    }).run()
                }
            ...
            $.runOnLoad(function() {
                f.run()
            }))) : t("Activator script doesn't have settings. No scripts will be executed.")
        } else
            t("Can't obtain activator script. No scripts will be executed.")
    }()
}();
